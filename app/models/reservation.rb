class Reservation < ApplicationRecord
  ...
  PACKAGES = {
    "starter" => {
      ...
      label: "AI 체험 코스",
      duration: "2주 (4시간)",
      features: ["1:1 코칭 4시간", "MVP 프로토타입 1개", "1개월 Q&A", "3개월 커뮤니티", "수강자 요청에 따라 AI활용등으로 커리큘럼 조정 가능"]
    },
    "standard" => {
      name: "STANDARD",
      price: 800_000,
      label: "AI 수익화 코스",
      duration: "4주 (8시간)",
      features: ["1:1 코칭 8시간", "완성형 앱 1개 + 배포", "3개월 Q&A", "1년 커뮤니티", "AI 도구 템플릿", "수강자 요청에 따라 AI활용등으로 커리큘럼 조정 가능"]
    },
    "premium" => {
      name: "PREMIUM",
      price: 1_200_000,
      label: "AI 창업 코스",
      duration: "6주 (12시간)",
      features: ["1:1 코칭 12시간", "앱 + 수익화 전략", "6개월 Q&A", "1년 VIP 커뮤니티", "AI 도구 템플릿 + 전자책", "월 1회 화상 멘토링", "수강자 요청에 따라 AI활용등으로 커리큘럼 조정 가능"]
    }
  }.freeze
